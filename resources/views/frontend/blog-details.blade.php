                                ...
                                <div class="blog-widget-body">
                                    <ul class="recent-post">
                                        ...
                                        <li class="single-post">
                                            <div class="post-img">
                                                <a href="/blog/{{ $relatedPost->categoryRelation->slog }}/{{ $relatedPost->slog }}"><img alt="{{ $relatedPost->title ?? '' }}"  src="{{ asset('public/assets/frontend/img/posts/' . ($relatedPost->imgs ?? 'default.jpg')) }}"
                                                        ></a>
                                            </div>
                                            <div class="post-content">
                                                <span>{{ $relatedPost->created_at ? $relatedPost->created_at->format('d M, Y') : '' }}</span>
                                                <h6><a href="/blog/{{ $relatedPost->categoryRelation->slog }}/{{ $relatedPost->slog }}">{{ \Illuminate\Support\Str::limit($relatedPost->title ?? 'Unknown Article', 50, '...') }}</a>
                                                </h6>
                                            </div>
                                        </li>
                                        @endforeach
                            ...
                            <div class="top-blog">
                                ...
                                <div class="blog-widget-body">
                                    <ul class="category-list">
                                        ...
                                        <li><a href="/blog/{{ $category->slog ?? '' }}"><span>{{ $category->title ?? '' }}</span><span>{{ $category->posts_count ?? '0' }}</span></a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
