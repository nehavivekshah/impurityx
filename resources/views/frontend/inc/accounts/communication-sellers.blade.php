...
<div class="dashboard-area box--shadow mt-4 mb-4">
    <div class="container-fluid">
        <div class="row">
            <!-- Left Column -->
            <form action="{{ url('/my-account/communication-sellers') }}" method="POST" class="col-md-5 border rounded @if(!request()->has('id')) p-4 @else p-0 @endif">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                ...
                                <div class="text-left flex-grow-1">
                                    <h5 class="mb-1" style="display: inline-flex ; align-items: center; gap: 10px;">
                                        ...
                                        <span class="badge {{ $getCom->status == 'open' ? 'bg-success' : 'bg-danger' }}" style="font-size: 13px; padding: 6px 10px; height: 20px; font-weight: 400;display: inline-flex ; align-items: center;">
                                            {{ $getCom->status == 'open' ? 'Open' : 'Closed' }}
                                        </span>
                                    </h5>
                                ...
                                <!-- Right: Status Badge -->
                                <div>
                                    <a href="{{ url('/my-account/communication-sellers') }}" class="btn btn-sm btn-dark">
                ...
                @if(!request()->has('id') || empty($getCom->reply) && ($type[0] == 'CSB'))
                        ...
                        @forelse($communications as $com)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('/my-account/communication-sellers?id=' . $com->id) }}"
