    ...
    <header class="header-area style-1">
            ...
            <ul class="menu-list">
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="submenu" style="z-index:999999;">
                        ...
                        <li>
                            <a href="/category/{{ $cat->slog }}">{{ $cat->title }}</a>
                        </li>
                        @endforeach
                    </ul>
                </li>
        ...
        <div class="nav-right d-flex align-items-center">
                ...
                <form action="/products" method="GET" class="search-form">
                    <div class="input-group">
                        <input type="text" class="form-control search-input" placeholder="Search Products Here..."
                            name="search" style="max-width: 255px;" value="{!! $_GET['search'] ?? '' !!}">
            ...
            <div class="profile-button-container btn-user d-md-block ms-2">
                ...
                <a @if(session('users')) href="/my-account/dashboard" @else href="/login" @endif
