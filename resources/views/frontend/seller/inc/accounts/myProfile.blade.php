<form action="{{ url('/seller/my-account/my-profile') }}" id="profileForm" method="POST" enctype="multipart/form-data">
    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="company" id="company" 
                                   value="{{ old('company', $user->company) }}" @if(!empty($user->company)) readonly @endif required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="trade" id="trade" 
                                   value="{{ old('trade', $user->trade) }}" @if(!empty($user->trade)) readonly @endif required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="panno" id="panno" 
                                   value="{{ old('panno', $user->panno) }}" @if(!empty($user->panno)) readonly @endif required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="vat" id="vat" 
                                   value="{{ old('vat', $user->vat) }}" @if(!empty($user->vat)) readonly @endif required>
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="regAddress" id="regAddress" 
                                   value="{{ old('regAddress', $user->regAddress) }}" @if(!empty($user->regAddress)) readonly @endif>
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="comAddress" id="comAddress" 
                                   value="{{ old('comAddress', $user->comAddress) }}" @if(!empty($user->comAddress)) readonly @endif>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="city" id="city" 
                                   value="{{ old('city', $user->city) }}" @if(!empty($user->city)) readonly @endif>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="state" id="state" 
                                   value="{{ old('state', $user->state) }}" @if(!empty($user->state)) readonly @endif>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="pincode" id="pincode" 
                                   value="{{ old('pincode', $user->pincode) }}" @if(!empty($user->pincode)) readonly @endif>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="country" id="country" 
                                   value="{{ old('country', $user->country ?? 'India') }}" @if(!empty($user->country)) readonly @endif>
                        </div>
