            ...
            <table id="example" class="table table-striped border rounded" style="width:100%;font-size: 14px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><strong>{{ date('y', strtotime($order->created_at)) . (date('y', strtotime($order->created_at)) + 1) . '-' . str_pad($order->id, 4, '0', STR_PAD_LEFT) }}</strong><br>
                        ...
                        <td class="text-center">@if(!empty($order->auction_end)) {{ \Carbon\Carbon::parse($order->auction_end)->format('d M, Y H:i') }} @else -- @endif</td>
                        <td class="text-center">
                        ...
                        <td class="text-center" width="90px">
                            <a href="javascript:void(0)" id="{{ $order->id }}" class="btn btn-sm btn-info view" title="View Details" data-page="sellerawardedorders">
                            ...
                            <a href="javascript:void(0)" class="btn btn-sm btn-dark edit-auction"
                               ...
                               data-invoiceno="{{ $order->invoice_no }}"
                               data-couriername="{{ $order->courier_name }}"
                            ...
                            @endif
                            <a href="/seller/dbaction?selectorId={{ $order->id }}&pagename=sellerawardedordersexport" class="btn btn-sm btn-primary" title="Download Order's Details">
        ...
        <div class="editContent p-3">
            <form id="editOrderForm" method="POST" action="/seller/update-order-seller-status" style="min-height: 290px;">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control" name="invoice_date" id="invoice_date" max="{{ date('Y-m-d') }}">
                </div>
