...
<div class="dashboard-area box--shadow mt-0 mt-md-5">
    <div class="container-fluid">
        <div class="row">
            <form action="/seller/my-account/supports" method="POST" class="col-md-5 border rounded @if(!request()->has('id')) p-4 @else p-0 @endif">
                @csrf
                @if(request()->has('id'))
                    <div class="card p-0 border-0">
                        ...
                        <div class="card-header bg-light text-dark">
                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                ...
                                <!-- Right: Status Badge -->
                                <div>
                                    <a href="{{ url('/seller/my-account/supports') }}" class="btn btn-sm btn-dark">
                        ...
                        @forelse($communications as $com)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('/seller/my-account/supports?id=' . $com->id) }}"
