    ...
    <header class="header-area style-1">
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="submenu" >
                        @foreach($dropdownCategories as $cat)
                            <li>
                                <a href="/seller/category/{{ $cat->slog }}">{{ $cat->title }}</a>
                            </li>
                        @endforeach
                    </ul>
                </li>
            ...
            <div class="d-lg-none d-block">
                <form action="/seller/products" method="GET" class="mobile-menu-form mb-5">
                    <div class="input-with-btn d-flex flex-column">
                        <input type="text" placeholder="Search here..." name="s" style="max-width: 255px;" value="{!! $_GET['search'] ?? '' !!}">
        ...
        <div class="nav-right d-flex align-items-center">
            ...
            <div class="profile-button-container btn-user d-md-block ms-2">
                ...
                <a @if(session('users') && ($user['role'] == '4')) href="/seller/my-account/dashboard" @else href="/seller/login" @endif class="eg-btn btn--primary btn--lg mobile-account-btn">
