            ...
            <div class="row gy-5">
                <div class="col-lg-8">
                    <div class="blog-details-single">
                        <div class="blog-img">
                            <img alt="image"  src="{{ asset('public/assets/frontend/img/posts/' . ($post->imgs ?? 'default.jpg')) }}" class="img-fluid wow fadeInDown" data-wow-duration="1.5s" data-wow-delay=".2s">
                        </div>
                        <ul class="blog-meta gap-2">
                            <li><a href="javascript:void(0)"><img alt="image"  src="/public/assets/frontend/images/icons/calendar.svg" >Date: {!! date_format(date_create($post->created_at ?? null),'d M, Y') !!}</a></li>
                            <!--<li><a href="javascript:void(0)"><img alt="image"  src="/public/assets/frontend/images/icons/tags.svg" >Auction</a></li>-->
                            <li><a href="javascript:void(0)"><img alt="image"  src="/public/assets/frontend/images/icons/admin.svg" >Posted by {{ $post->author ?? '--'}}</a></li>
                        </ul>
                                ...
                                <div class="blog-widget-body">
                                    <ul class="recent-post">
                                        ...
                                        <li class="single-post">
                                            <div class="post-img">
                                                <a href="/seller/blog/{{ $relatedPost->categoryRelation->slog }}/{{ $relatedPost->slog }}"><img alt="{{ $relatedPost->title ?? '' }}"  src="{{ asset('public/assets/frontend/img/posts/' . ($relatedPost->imgs ?? 'default.jpg')) }}"
                                                        ></a>
                                            </div>
                                            <div class="post-content">
                                                <span>{{ $relatedPost->created_at ? $relatedPost->created_at->format('d M, Y') : '' }}</span>
                                                <h6><a href="/seller/blog/{{ $relatedPost->categoryRelation->slog }}/{{ $relatedPost->slog }}">{{ \Illuminate\Support\Str::limit($relatedPost->title ?? 'Unknown Article', 50, '...') }}</a>
                                                </h6>
                                            </div>
                                        </li>
                                        @endforeach
                            ...
                            <div class="top-blog">
                                ...
                                <div class="blog-widget-body">
                                    <ul class="category-list">
                                        ...
                                        <li><a href="/seller/blog/{{ $category->slog ?? '' }}"><span>{{ $category->title ?? '' }}</span><span>{{ $category->posts_count ?? '0' }}</span></a></li>
                                        @endforeach
                                    </ul>
                                </div>
                            </div>
