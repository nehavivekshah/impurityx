...
<div class="dashboard-area box--shadow mt-4 mb-4">
    <div class="container-fluid">
        <div class="row">
            <!-- Left Column -->
            <form action="<?php echo e(url('/my-account/communication-sellers')); ?>" method="POST" class="col-md-5 border rounded <?php if(!request()->has('id')): ?> p-4 <?php else: ?> p-0 <?php endif; ?>">
                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                ...
                                <div class="text-left flex-grow-1">
                                    <h5 class="mb-1" style="display: inline-flex ; align-items: center; gap: 10px;">
                                        ...
                                        <span class="badge <?php echo e($getCom->status == 'open' ? 'bg-success' : 'bg-danger'); ?>" style="font-size: 13px; padding: 6px 10px; height: 20px; font-weight: 400;display: inline-flex ; align-items: center;">
                                            <?php echo e($getCom->status == 'open' ? 'Open' : 'Closed'); ?>
                                ...
                                <!-- Right: Status Badge -->
                                <div>
                                    <a href="<?php echo e(url('/my-account/communication-sellers')); ?>" class="btn btn-sm btn-dark">
                ...
                <?php if(!request()->has('id') || empty($getCom->reply) && ($type[0] == 'CSB')): ?>
                    ...
                    <div class="mb-3">
                        ...
                        <label for="message" class="fw-bold">Buyer Reply:</label>
            ...
            <div class="col-md-7">
                ...
                <div class="col-md-12 px-0 px-md-3 mb-3">
                    <form method="POST" action="/my-account/communication-sellers/export" class="row bg-light border py-3">
                        <?php echo csrf_field(); ?>
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $communications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $com): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo e(url('/my-account/communication-sellers?id=' . $com->id)); ?>"
...
<?php $__env->stopSection(); ?><?php /**PATH /home/u321815713/domains/impurityx.com/public_html/resources/views//frontend/inc/accounts/communication-sellers.blade.php ENDPATH**/ ?>