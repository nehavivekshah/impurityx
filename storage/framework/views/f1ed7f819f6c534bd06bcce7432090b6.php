<form action="<?php echo e(url('/seller/my-account/my-profile')); ?>" id="profileForm" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
                    ...
                    <div class="d-flex align-items-center mb-4">
                        <div class="me-3">
                            <img id="profilePreview" 
                                 src="<?php echo e($user->photo ? asset('/public/assets/frontend/img/users/'.$user->photo) : asset('/public/assets/frontend/images/icons/admin.svg')); ?>" 
                                 alt="Profile Picture" 
                                 class="rounded-circle border" width="100" height="100">
                        </div>
                        <div>
                            <h4 class="mb-0 fw-bold"><?php echo e($user->first_name); ?> <?php echo e($user->last_name); ?></h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="contact" minlength="11" maxlength="13" id="contact" 
                                   value="<?php echo e(old('mob', $user->mob)); ?>">
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="company" id="company" 
                                   value="<?php echo e(old('company', $user->company)); ?>" <?php if(!empty($user->company)): ?> readonly <?php endif; ?> required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="trade" id="trade" 
                                   value="<?php echo e(old('trade', $user->trade)); ?>" <?php if(!empty($user->trade)): ?> readonly <?php endif; ?> required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="panno" id="panno" 
                                   value="<?php echo e(old('panno', $user->panno)); ?>" <?php if(!empty($user->panno)): ?> readonly <?php endif; ?> required>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="vat" id="vat" 
                                   value="<?php echo e(old('vat', $user->vat)); ?>" <?php if(!empty($user->vat)): ?> readonly <?php endif; ?> required>
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="regAddress" id="regAddress" 
                                   value="<?php echo e(old('regAddress', $user->regAddress)); ?>" <?php if(!empty($user->regAddress)): ?> readonly <?php endif; ?>>
                        </div>

                        <!-- Communication Address -->
                        <div class="col-md-12 mb-3">
                            <label for="comAddress" class="fw-bold">Communication Address</label>
                            <input type="text" class="form-control" name="comAddress" id="comAddress" 
                                   value="<?php echo e(old('comAddress', $user->comAddress)); ?>" <?php if(!empty($user->comAddress)): ?> readonly <?php endif; ?>>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="city" id="city" 
                                   value="<?php echo e(old('city', $user->city)); ?>" <?php if(!empty($user->city)): ?> readonly <?php endif; ?>>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="state" id="state" 
                                   value="<?php echo e(old('state', $user->state)); ?>" <?php if(!empty($user->state)): ?> readonly <?php endif; ?>>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="pincode" id="pincode" 
                                   value="<?php echo e(old('pincode', $user->pincode)); ?>" <?php if(!empty($user->pincode)): ?> readonly <?php endif; ?>>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="country" id="country" 
                                   value="<?php echo e(old('country', $user->country ?? 'India')); ?>" <?php if(!empty($user->country)): ?> readonly <?php endif; ?>>
                        </div>
...
</script><?php /**PATH /home/u321815713/domains/impurityx.com/public_html/resources/views//frontend/seller/inc/accounts/myProfile.blade.php ENDPATH**/ ?>