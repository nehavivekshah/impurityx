<?php $__env->startSection('title','Dashboard - Impurity X'); ?>
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value">#<?php echo e($AdminNotActiveBidsCount ?? '0'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value">#<?php echo e($AdminPendingBidsCount ?? '0'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value text-dark">#<?php echo e($newBuyersCount ?? '0'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value text-dark">#<?php echo e($newSellersCount ?? '0'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value text-dark">#<?php echo e($AdminInterMailCount ?? '0'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value">#<?php echo e($nprCount ?? '0'); ?></div>
                        </div>
                    </div>
                </div>
            </div> 
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value">#<?php echo e($myActiveBidsCount ?? '0'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value">#<?php echo e($myNonActiveBidsCount ?? '0'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value text-dark">#<?php echo e($myAPBidsCount ?? '0'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value text-dark">#<?php echo e($myABBidsCount ?? '0'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value text-dark">#<?php echo e($myAABidsCount ?? '0'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div style="width: 100%;">
                            ...
                            <div class="flex mt-2 text-black" style="display:flex;gap:5px;justify-content:space-between;">
                                <div class="col">
                                    <div>MTD</div>
                                    <div>#<?php echo e($mtdCount); ?></div>
                                    <div><?php echo e(formatIndianAmount($mtdAmount, 2)); ?></div>
                                </div>
                        
                                <div class="col">
                                    <div>YTD</div>
                                    <div>#<?php echo e($ytdCount); ?></div>
                                    <div><?php echo e(formatIndianAmount($ytdAmount, 2)); ?></div>
                                </div>
                        
                                <div class="col">
                                    <div>CTD</div>
                                    <div>#<?php echo e($ctdCount); ?></div>
                                    <div><?php echo e(formatIndianAmount($ctdAmount, 2)); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value">#<?php echo e($myBuyerActiveCount ?? '0'); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value text-dark">#<?php echo e($mySellerActiveCount ?? '0'); ?></div>
                        </div>
                    </div>
                </div>
            </div> 
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value">#<?php echo e($wipOrdercount); ?> 
                           Rs. <?php echo e(formatIndianAmount($wipOrderAmt, 2)); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value"><!--#<?php echo e($otcOrdercount); ?> -->
                           Rs. <?php echo e(formatIndianAmount($otcOrderAmt, 2)); ?> </div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div style="width:100%;">
                            ...
                            <div class="flex mt-2 text-black" style="display:flex; justify-content:space-between;">
                                <div class="col">
                                    <div>MTD</div>
                                    <div>#<?php echo e($oCmtdCount); ?></div>
                                    <div><?php echo e(formatIndianAmount($oCmtdAmount, 2)); ?></div>
                                </div>
                        
                                <div class="col">
                                    <div>YTD</div>
                                    <div>#<?php echo e($oCytdCount); ?></div>
                                    <div><?php echo e(formatIndianAmount($oCytdAmount, 2)); ?></div>
                                </div>
                        
                                <div class="col">
                                    <div>CTD</div>
                                    <div>#<?php echo e($oCctdCount); ?></div>
                                    <div><?php echo e(formatIndianAmount($oCctdAmount, 2)); ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value">#<?php echo e($totalSellersCount); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value">#<?php echo e($totalActiveSellersCount); ?></div>
                        </div>
                    </div>
                </div>
            </div>  
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value text-dark">#<?php echo e($totalBuyersCount); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value text-dark">#<?php echo e($totalActiveBuyersCount); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value">#<?php echo e($dilOrdercount); ?> 
                           Rs. <?php echo e(formatIndianAmount($dilOrderAmt, 2)); ?> </div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card kpi-card border-bottom-primary">
                    <div class="card-body d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <div class="kpi-card__value text-dark">#<?php echo e($completelOrdercount); ?> 
                           Rs. <?php echo e(formatIndianAmount($completelOrderAmt, 2)); ?></div>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u321815713/domains/impurityx.com/public_html/resources/views/backend/home.blade.php ENDPATH**/ ?>