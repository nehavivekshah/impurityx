            ...
            <div class="row gy-5">
                <div class="col-lg-3 col-md-6">
                    <div class="footer-item">
                        <h5>Overview</h5>
                        <!-- <a href="/index.html"><img alt="image" src="/assets/frontend/img/logo/logo.jpg"></a> -->
                        <p>At ImpurityX, we specialize in bridging the gap between chemical manufacturers, suppliers,
        ...
        <div class="container">
            <div class="row d-flex align-items-center g-4">
                <div class="col-lg-12 d-flex justify-content-lg-center justify-content-center">
                    <p><a href="">ImpurityX</a> Copyright 2025 | Developed By <a href="/https://webbrella.com/"
                            class="egns-lab">Webbrella Infotech</a></p>
                </div>
                <div
                    class="col-lg-6 d-flex justify-content-lg-end justify-content-center align-items-center flex-sm-nowrap flex-wrap d-none">
...
</html><?php /**PATH /home/u321815713/domains/impurityx.com/public_html/resources/views//frontend/inc/footer.blade.php ENDPATH**/ ?>