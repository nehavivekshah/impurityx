...
<div class="dashboard-area box--shadow mt-0 mt-md-5">
    <div class="container-fluid">
        <div class="row">
            <form action="/my-account/supports" method="POST" class="col-md-5 border rounded <?php if(!request()->has('id')): ?> p-4 <?php else: ?> p-0 <?php endif; ?>">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="card p-0 border-0">
                        ...
                        <div class="card-header bg-light text-dark">
                            <div class="d-flex align-items-center justify-content-between flex-wrap">
                                ...
                                <!-- Right: Status Badge -->
                                <div>
                                    <a href="<?php echo e(url('/my-account/supports')); ?>" class="btn btn-sm btn-dark">
                        ...
                        <?php $__empty_1 = true; $__currentLoopData = $communications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $com): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo e(url('/my-account/supports?id=' . $com->id)); ?>"
...
<?php $__env->stopSection(); ?><?php /**PATH /home/u321815713/domains/impurityx.com/public_html/resources/views//frontend/inc/accounts/communication-support.blade.php ENDPATH**/ ?>