...
<body>
    ...
    <div class="topbar">
        ...
        <!-- <div class="email-area">
            <span>
                <i class="bx bx-envelope"></i>
                <a href="mailto:iwebbrella@gmail.com">
                    <span>iwebbrella@gmail.com</span>
                </a>
            </span>
        </div> -->
        <div class="topbar-right">
            <ul class="topbar-right-list">
                <li>
                    <a href="/seller/register" class="eg-btn seller-btn btn--lg" target="_blank">Become a Seller</a>
                </li>
                <?php if(!session('users')): ?>
                <li>
                    <a href="/register" class="eg-btn buyer-btn btn--lg">Register to Buy</a>
                </li>
                <?php endif; ?>
                <li>
                    <ul class="social-icon d-flex gap-2">
                        <li>
                            <a href="https://www.facebook.com/profile.php?id=61582013601892" target="_blank">
                                <img src="/public/assets/frontend/img/icon/social/1.png" alt="facebook"
                                    class="img-fluid">
                            </a>
                        </li>
                        <li>
                            <a href="https://www.instagram.com/impurityx_thirdworld_innomart" target="_blank">
                                <img src="/public/assets/frontend/img/icon/social/2.png" alt="instagram"
                                    class="img-fluid">
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="https://www.linkedin.com/showcase/impurityx" target="_blank">
                                <img src="/public/assets/frontend/img/icon/social/3.png" alt="linkedin"
                                    class="img-fluid">
                            </a>
                        </li>
                    </ul>
                </li>
                <!--<li class="d-none">Currency
                    <ul class="topbar-sublist">
                        <li><a href="/login"><i class="bi bi-currency-dollar"></i>Usd</a></li>
                        <li><a href="/register"><i class="bi bi-currency-euro"></i>Euro</a></li>
                        <li><a href="/register"><i class="bi bi-currency-pound"></i>Pound</a></li>
                    </ul>
                </li>-->
            </ul>
        </div>
    ...
    <header class="header-area style-1">
        <div class="header-logo">
            <a href="/"><img class="img-fluid logo-impurity" alt="image" src="/assets/frontend/images/logo.png"></a>
        </div>
        <div class="main-menu">
            <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                <div class="mobile-logo-wrap">
                    <a href="/"><img class="img-fluid logo-impurity" alt="image"
            ...
            <ul class="menu-list">
                ...
                <li class="menu-item-has-children">
                    <a href="/products" class="drop-down">Categories</a>
                    <i class="bx bx-plus dropdown-icon"></i>
                    <ul class="submenu" style="z-index:999999;">
                        ...
                        <li>
                            <a href="/category/<?php echo e($cat->slog); ?>"><?php echo e($cat->title); ?></a>
                        </li>
            ...
            <div class="d-lg-none d-block">
                <form action="/products" method="GET" class="mobile-menu-form mb-5">
                    <div class="input-with-btn d-flex flex-column">
                        <input type="text" placeholder="Search here..." name="s" style="max-width: 255px;"
        ...
        <div class="nav-right d-flex align-items-center">
            ...
            <div class="profile-button-container btn-user d-md-block ms-2">
                ...
                <a <?php if(session('users')): ?> href="/my-account/dashboard" <?php else: ?> href="/login" <?php endif; ?>
                    class="eg-btn btn--primary btn--lg mobile-account-btn">
    ...
    </header><?php /**PATH /home/u321815713/domains/impurityx.com/public_html/resources/views//frontend/inc/header.blade.php ENDPATH**/ ?>