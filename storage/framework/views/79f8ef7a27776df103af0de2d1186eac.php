        ...
        <div class="col-md-12 px-3 bg-white">
            <table id="example" class="table table-striped border rounded" style="width:100%;font-size: 14px;">
                ...
                <tbody>
                    ...
                    <?php $gst = ((($order->order_val ?? 0)*($order->gst ?? 0))/100); ?>
                    <tr>
                        ...
                        <td>Rs. <?php echo e((($order->order_val ?? 0) + $gst)); ?></td>
                    </tr>
...
<?php $__env->stopSection(); ?><?php /**PATH /home/u321815713/domains/impurityx.com/public_html/resources/views//frontend/seller/inc/accounts/sales-report.blade.php ENDPATH**/ ?>