    ...
    <div class="hero-main-wrapper position-relative">
        <div class="swiper banner1 special-mobile-responsive">
            <div class="swiper-wrapper">
                ...
                <style>
                    .slider-bg-<?php echo e($slider->id); ?> {
                        content: "";
                        position: absolute;
                        top: 0;
                        left: 0;
                ...
                <div class="swiper-slide">
                    <div class="slider-bg-<?php echo e($slider->id); ?> position-relative overflow-hidden" style="background-image: url('<?php echo e(asset('public/assets/frontend/img/sliders/' . $slider->imgs)); ?>');">
                        <div class="container">
                            <div class="row d-flex justify-content-center align-items-center">
                                <div class="col-xl-10 col-lg-10">
                                    <div class="banner1-content text-center">
                                        <?php if(!empty($slider->title)): ?><h1><?php echo e($slider->title); ?></h1><?php endif; ?>
                                        <?php if(!empty($slider->subtitle)): ?><p><?php echo e($slider->subtitle); ?></p><?php endif; ?>
                                        <?php if(!empty($slider->link)): ?>
                                            <a href="<?php echo e($slider->link); ?>" class="eg-btn btn--primary btn--lg">
                                                <?php echo e($slider->btntext ?? 'Learn More'); ?>
        ...
        <div class="row d-flex justify-content-center">
            <div class="swiper category1-slider">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <a href="/seller/category/<?php echo e($category->slog ?? 'Unknown'); ?>">
                            <div class="eg-card category-card1 wow animate fadeInDown" data-wow-duration="1500ms"
                                data-wow-delay="200ms">
                                <div class="cat-icon">
                                    <img class="img-fluid" src="/public/assets/frontend/img/category/icons/<?php echo e($category->icon ?? 'Unknown'); ?>" alt="<?php echo e($category->slog ?? 'Unknown'); ?>">
                                </div>
                                <h5><?php echo e($category->title ?? 'Unknown'); ?></h5>
                            </div>
                        </a>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="col-6 col-lg-3 col-md-6 col-sm-10">
                    <div class="eg-card auction-card1 wow animate fadeInDown" data-wow-duration="1.5s" data-wow-delay="0.2s">
                        <div class="auction-img">
                            <img alt="<?php echo e($product->name ?? 'Unknown'); ?>" src="/public/assets/frontend/img/products/<?php echo e($product->img ?? 'Unknown'); ?>">
                        </div>
                        <div class="auction-content">
                            <div class="auction-timer">
                                <?php if($auctionEnd && \Carbon\Carbon::parse($auctionEnd)->isFuture()): ?>
                                    <div class="countdown" data-endtime="<?php echo e($auctionEnd); ?>">
                                ...
                                <?php elseif(empty($product->auction_end)): ?>
                            ...
                            <h4><a href="/seller/product/<?php echo e($product->slog ?? 'unknown'); ?>/<?php echo e($product->id ?? 'Unknown'); ?>"><?php echo e($product->name ?? 'Unknown'); ?></a></h4>
                            <h5 class="subtext-gray">(Qty: <?php echo e($product->quantity ?? null); ?> <?php echo e($product->uom ?? ''); ?>, EDD: <?php echo date_format(date_create($product->delivery_date ?? null),'d M, Y'); ?>)</h5>
                            <div class="auction-card-bttm">
                                <a href="/seller/product/<?php echo e($product->slog ?? 'unknown'); ?>/<?php echo e($product->id ?? 'Unknown'); ?>" class="eg-btn btn--primary btn--sm">Place your Bid</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('.frontend.seller.inc.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u321815713/domains/impurityx.com/public_html/resources/views/frontend/seller/index.blade.php ENDPATH**/ ?>