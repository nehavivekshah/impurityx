                                ...
                                <div class="blog-widget-body">
                                    <ul class="recent-post">
                                        ...
                                        <li class="single-post">
                                            <div class="post-img">
                                                <a href="/blog/<?php echo e($relatedPost->categoryRelation->slog); ?>/<?php echo e($relatedPost->slog); ?>"><img alt="<?php echo e($relatedPost->title ?? ''); ?>"  src="<?php echo e(asset('public/assets/frontend/img/posts/' . ($relatedPost->imgs ?? 'default.jpg'))); ?>"
                                                        ></a>
                                            </div>
                                            <div class="post-content">
                                                <span><?php echo e($relatedPost->created_at ? $relatedPost->created_at->format('d M, Y') : ''); ?></span>
                                                <h6><a href="/blog/<?php echo e($relatedPost->categoryRelation->slog); ?>/<?php echo e($relatedPost->slog); ?>"><?php echo e(\Illuminate\Support\Str::limit($relatedPost->title ?? 'Unknown Article', 50, '...')); ?></a>
                                                </h6>
                                            </div>
                                        </li>
                            ...
                            <div class="top-blog">
                                ...
                                <div class="blog-widget-body">
                                    <ul class="category-list">
                                        ...
                                        <li><a href="/blog/<?php echo e($category->slog ?? ''); ?>"><span><?php echo e($category->title ?? ''); ?></span><span><?php echo e($category->posts_count ?? '0'); ?></span></a></li>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </ul>
                                </div>
                            </div>
...
<?php echo $__env->make('.frontend.inc.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u321815713/domains/impurityx.com/public_html/resources/views/frontend/blog-details.blade.php ENDPATH**/ ?>