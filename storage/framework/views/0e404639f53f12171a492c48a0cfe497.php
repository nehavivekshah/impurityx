...
<body>
        ...
        <div class="container">
            <div class="row pb-120 mb-70 g-4 d-flex justify-content-center">
                <div class="col-lg-6 col-md-6 col-sm-8">
                    <div class="contact-signle hover-border1 d-flex flex-row align-items-start wow fadeInDown"
                        ...
                        <div class="text">
                            <h4>Location</h4>
                            <p><span class="fw-bold">ThirdWorld Innomart Private Limited</span> <br class="d-none d-md-block">G-159, B Wing, Express Zone Mall, Western Express
                                Highway, Malad East, Near Dindoshi Metro Station, Mumbai 400097, Maharashtra, India.
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-8">
                    <div class="contact-signle hover-border1 d-flex flex-row align-items-start wow fadeInDown"
                        ...
                        <div class="text">
                            <h4>Phone</h4>
                            <a href="tel:+919619775533">+91 8554999074</a>
                        </div>  
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-sm-8">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-6">
                    <div class="map-area wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".4s">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3768.426822457568!2d72.85584097395392!3d19.176551248810636!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b707374fdf5b%3A0xdb893aa5be338aa0!2sExpress%20Zone%20B%20Wing!5e0!3m2!1sen!2sin!4v1751606454371!5m2!1sen!2sin"
    ...
    <!-- =============== counter-section end =============== -->
<?php echo $__env->make('.frontend.inc.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u321815713/domains/impurityx.com/public_html/resources/views/frontend/contact-us.blade.php ENDPATH**/ ?>