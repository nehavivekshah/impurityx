            ...
            <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-10">
                    <div class="single-blog-style1 wow fadeInDown" data-wow-duration="1.5s" data-wow-delay=".2s">
                        <div class="blog-img">
                            <a href="/seller/blog/<?php echo e($post->categoryRelation->slog); ?>/<?php echo e($post->slog); ?>" class="blog-date">
                                <i class="bi bi-calendar-check"></i>
                                <?php echo e($post->created_at ? $post->created_at->format('d M, Y') : ''); ?>

                            </a>
                            <a href="/seller/blog/<?php echo e($post->categoryRelation->slog); ?>/<?php echo e($post->slog); ?>">
                                <img alt="image" src="<?php echo e(asset('public/assets/frontend/img/posts/' . ($post->imgs ?? 'default.jpg'))); ?>">
                            </a>
                        </div>
                        <div class="blog-content">
                            ...
                            <div class="blog-meta">
                                <div class="comment">
                                    <img alt="image" src="<?php echo e(asset('public/assets/frontend/images/icons/tags.svg')); ?>">
                                    <a href="javascript:void(0)" class="comment">
                                        <?php echo e($post->category ?? 0); ?>

                                    </a>
                                </div>
                                <div class="author">
                                    <img alt="image" src="<?php echo e(asset('public/assets/frontend/images/blog/user.png')); ?>">
...
<?php echo $__env->make('.frontend.seller.inc.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u321815713/domains/impurityx.com/public_html/resources/views/frontend/seller/blog.blade.php ENDPATH**/ ?>