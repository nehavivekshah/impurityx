...
<style>
    ...
    /* .swiper-slide.swiper-slide-prev.swiper-slide-duplicate-next{
     ...
     div#swiper-wrapper-470f10d6a7246a113{
        transform: none !important;
     }
...
<!-- ========== banner-area============= -->
<div class="hero-area hero-style-one" style="z-index:0">
...
<div class="category-section pt-120 pb-120">
    <div class="container category-index position-relative">
        <div class="row d-flex justify-content-center">
            <div class="swiper category1-slider">
                <div class="swiper-wrapper">
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="swiper-slide">
                        <a href="/category/<?php echo e($category->slog ?? 'Unknown'); ?>">
    ...
    <div class="container position-relative">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-sm-12 col-md-10 col-lg-8 col-xl-6">
                <div class="section-title1">
                    <h2>Our Products</h2>
                    <p class="mb-0">
                        We specialize in a wide range of industrial, specialty, and fine chemicals sourced from verified and trusted manufacturers and traders.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div data-wow-duration="1.5s" data-wow-delay="0.2s"
                    ...
                    <div class="auction-content">
                        ...
                        <div class="auction-card-bttm">
                            <a href="/product/<?php echo e($product->slog ?? 'unknown'); ?>" class="eg-btn btn--primary btn--sm">Place An Order</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-4 text-center product-btn">
                <a href="/products" class="eg-btn btn--primary btn--md mx-auto btn-products">View All Products</a>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('frontend.inc.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u321815713/domains/impurityx.com/public_html/resources/views/frontend/index.blade.php ENDPATH**/ ?>