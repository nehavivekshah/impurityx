<form action="<?php echo e(url('/my-account/my-profile')); ?>" id="profileForm" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-12 border rounded p-4">
                    ...
                    <div class="row">
                        ...
                        <!--           value="<?php echo e(old('company', $user->company)); ?>" required>-->
                        <!--</div>-->
                        ...
                        <!--           value="<?php echo e(old('trade', $user->trade)); ?>" required>-->
                        <!--</div>-->
                        ...
                        <!--           value="<?php echo e(old('panno', $user->panno)); ?>" required>-->
                        <!--</div>-->
                        ...
                        <!--           value="<?php echo e(old('vat', $user->vat)); ?>" required>-->
                        <!--</div>-->
                        ...
                        <!--           value="<?php echo e(old('regAddress', $user->regAddress)); ?>">-->
                        <!--</div>-->
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="comAddress" id="comAddress" 
                                   value="<?php echo e(old('comAddress', $user->comAddress)); ?>" readonly>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="city" id="city" 
                                   value="<?php echo e(old('city', $user->city)); ?>" readonly>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="state" id="state" 
                                   value="<?php echo e(old('state', $user->state)); ?>" readonly>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="pincode" id="pincode" 
                                   value="<?php echo e(old('pincode', $user->pincode)); ?>" readonly>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="country" id="country" 
                                   value="<?php echo e(old('country', $user->country ?? 'India')); ?>" readonly>
                        </div>
...
</script><?php /**PATH /home/u321815713/domains/impurityx.com/public_html/resources/views//frontend/inc/accounts/myProfile.blade.php ENDPATH**/ ?>