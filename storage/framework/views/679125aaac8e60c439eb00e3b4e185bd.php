...
<body>
                ...
                <div class="col-xl-7 col-lg-8 col-md-10">
                    <div class="form-wrapper wow fadeInUp" data-wow-duration="1.5s" data-wow-delay=".2s">
                        ...
                        <form action="/register" method="POST" class="w-100">
                            ...
                            <button class="account-btn my-4" name="submit" type="submit">Create My Buyer Account</button>
                        </form>
    ...
    <!-- ===============  Hero area end=============== -->
<?php echo $__env->make('.frontend.inc.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u321815713/domains/impurityx.com/public_html/resources/views/frontend/buyer-register.blade.php ENDPATH**/ ?>