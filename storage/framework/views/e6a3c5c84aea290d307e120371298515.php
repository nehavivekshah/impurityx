...
<div class="nav flex-column nav-pills gap-1 wow fadeInUp">
    ...
    <!-- Dashboard -->
    <a href="/my-account/dashboard" class="nav-link nav-btn-style mx-auto mb-20 <?php echo e(request()->is('my-account/dashboard') ? 'active' : ''); ?>"><span><i class='bx bxs-dashboard me-2'></i> Dashboard</span></a>
    ...
    <div class="nav-item">
        ...
        <div class="collapse <?php echo e(collect(['my-account/my-orders*', 'my-account/supports*', 'my-account/communication-sellers*', 'my-account/request-order*', 'my-account/delivery-acceptance*'])->contains(fn($route) => request()->is($route)) ? 'show' : ''); ?> mt-1 ms-3" id="actionTaskMenu">
            <ul class="list-unstyled">
                <li class="">
                    <a class="text-decoration-none d-flex align-items-center <?php echo e(request()->is('my-account/my-orders') ? 'active' : ''); ?>" href="/my-account/my-orders">
                        <i class='bx bx-play-circle me-2'></i> My Orders
                    </a>
                </li>
                <li class="">
                    <a class="text-decoration-none d-flex align-items-center <?php echo e(request()->is('my-account/supports') ? 'active' : ''); ?>" href="/my-account/supports">
                        <i class='bx bx-support me-2'></i> Communicate with Support
                    </a>
                </li>
                <li class="">
                    <a class="text-decoration-none d-flex align-items-center <?php echo e(request()->is('my-account/communication-sellers') ? 'active' : ''); ?>" href="/my-account/communication-sellers">
                        <i class='bx bx-support me-2'></i> Communicate with Sellers
                    </a>
                </li>
                <li class="">
                    <a class="text-decoration-none d-flex align-items-center <?php echo e(request()->is('my-account/request-order') ? 'active' : ''); ?>" href="/my-account/request-order">
                        <i class='bx bx-plus-circle me-2'></i> Request Product Addition
                    </a>
                </li>
                <li class="">
                    <a class="text-decoration-none d-flex align-items-center <?php echo e(request()->is('my-account/delivery-acceptance') ? 'active' : ''); ?>" href="/my-account/delivery-acceptance">
    ...
    <div class="nav-item">
        ...
        <div class="collapse <?php echo e(collect(['my-account/process-orders*', 'my-account/completed-orders*', 'my-account/all-orders*', 'my-account/purchase-report*'])->contains(fn($route) => request()->is($route)) ? 'show' : ''); ?> mt-1 ms-3" id="reportsMenu">
            <ul class="list-unstyled">
                <!--<li class="">
                ...
                <li class="">
                    <a class="text-decoration-none d-flex align-items-center <?php echo e(request()->is('my-account/process-orders') ? 'active' : ''); ?>" href="/my-account/process-orders">
                        <i class='bx bx-loader me-2'></i> In Process Orders
                    </a>
                </li>
    
                <li class="">
                    <a class="text-decoration-none d-flex align-items-center <?php echo e(request()->is('my-account/completed-orders') ? 'active' : ''); ?>" href="/my-account/completed-orders">
                ...
                <li class="">
                    <a class="text-decoration-none d-flex align-items-center <?php echo e(request()->is('my-account/all-orders') ? 'active' : ''); ?>" href="/my-account/all-orders">
                        <i class='bx bx-list-ul me-2'></i> All Orders
                    </a>
                </li>
    
                <li class="">
                    <a class="text-decoration-none d-flex align-items-center <?php echo e(request()->is('my-account/purchase-report') ? 'active' : ''); ?>" href="/my-account/purchase-report">
    ...
    <!-- My Profile -->
    <a href="/my-account/my-profile" class="nav-link nav-btn-style mx-auto mb-20 <?php echo e(request()->is('my-account/my-profile') ? 'active' : ''); ?>"><span><i class='bx bxs-user me-2'></i> My Profile</span></a>
...
</div><?php /**PATH /home/u321815713/domains/impurityx.com/public_html/resources/views//frontend/inc/sidebar.blade.php ENDPATH**/ ?>