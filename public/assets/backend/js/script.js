...
/*function tskedit(){
    document.querySelector(".task_pop_section").style = 'display:block!important;';
}

function closepop(){
    document.getElementById("task_pop_section").style = 'width:0%!important;';
    document.getElementById("task_pop_section").style = 'height:0%!important;';
    document.getElementById("task_pop_section").style = 'display:none!important;';
}*/
